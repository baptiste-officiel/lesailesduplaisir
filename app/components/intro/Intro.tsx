...
// const dimension = Math.round(imageDimensions.height)
  ...
  return (    
    <section className={` ${clash.variable} font-title relative block mt-16 w-full mx-auto pl-4`}>
      ...
      <Image id='image' src={'/img/plane-intro.png'} width={1000} height={500} alt='hélice VL3' className=' z-0 mr-0 ml-auto relative -right-16 -top-20 w-[100%] min-w-[300px] max-w-[700px] sm:pt-0' />
    </section>
  )
}
